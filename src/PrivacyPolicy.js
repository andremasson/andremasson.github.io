...
function PrivacyPolicy() {
  ...
  return (
    <Container className={classes.text}>
      ...
      <p>Effective date: May 31, 2019</p>      
      
      <p>Space Timber ("us", "we", or "our") operates the Space Timber mobile application (hereinafter referred to as the "Service").</p>
      
      <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. The Privacy Policy  for Space Timber has been created with the help of <a href="https://www.termsfeed.com/">TermsFeed</a>.</p>
      ...
      <ul>
        <li>
          ...
          <p>Service is the Space Timber mobile application operated by Space Timber</p>
        </li>
        <li>
      ...
      <p>Space Timber uses the collected data for various purposes:</p>    
      <ul>
      ...
      <p>Space Timber will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
      
      <h2>Disclosure Of Data</h2>
      
      <h3>Legal Requirements</h3>
      <p>Space Timber may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of Space Timber</li>
      ...
      <ul>
        <li>By email: contact@andremasson.me</li>
      </ul>
    </Container>
  );
}
